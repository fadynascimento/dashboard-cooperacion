...
if df is not None:
    ...
    if not df_timeline.empty:
        ...
        fig.update_traces(textposition='inside', insidetextanchor='middle', textfont=dict(size=16))
        
        fig.update_layout(
            showlegend=False,
            xaxis=dict(side="top", range=[now_z - timedelta(hours=2), now_z + timedelta(hours=2)],
